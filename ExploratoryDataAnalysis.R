...
#It looks like despite removing columns that were over 80% 0s,
...
########################################
# Both sets of data once more:
#######################################

#Demographic Data without femaleres and hhsize
depression.demographic <- depression.data[,c(1,2,4,5,6,8,9)]
